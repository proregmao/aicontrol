...
**核心问题**: 虽然有完整的设计文档，但开发时完全忽视设计要求，导致：
- 实际页面与设计图完全不符
- 功能只有占位符，没有真实实现
- 违背了所有设计规范
- 前期设计工作完全白费
...
# 开发任何页面前必须执行：
echo "📖 开发页面: [页面名称]"
echo "📋 设计文档: docs/02-design/ui-design/智能机房管理系统-完整UI展示.html"

# 强制打开设计图对照
open docs/02-design/ui-design/智能机房管理系统-完整UI展示.html
